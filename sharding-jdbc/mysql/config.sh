...
change master to master_host='mysql-master2', master_user='slave', master_password='123456', master_port=4306, master_log_file='master1-bin.000007', master_log_pos=154, master_connect_retry=30;
